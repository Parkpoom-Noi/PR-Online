...
Public Class frmPreviews
    ...
    Private Sub btnEdit_Click(sender As Object, e As EventArgs) Handles btnEditPr.Click

        frmEditPR._strPr = lbTagID.Text
        frmEditPR.frmEditPR_Load()
        frmEditPR.Show()
        Me.Hide()
    End Sub
...
#Region "All Sub and Function"
    ...
    Public Sub GetTagPr()
        ...
        If dtTagPR.Rows.Count > 0 Then
            ...
            '
            If IsDBNull(dtTagPR.Rows(0)("pr_ol_req_mgrStatus")) Then
            ...
            If dtTagPR.Rows(0)("pr_ol_GlStatus") = 5 Then
            ...
            Else
                pbStatusReqMgr.Image = My.Resources._error
            End If
            lbGlMgr.Text = dtTagPR.Rows(0)("pr_ol_GlName")
    ...
    Public Sub frmPreviews_Load() Handles MyBase.Load
        ...
        End If
        If prStatus = 0 Or prStatus = 2 Or prStatus = 4 Or prStatus = 6 Or prStatus = 8 Then
            btnEditPr.Visible = True
        Else
            btnEditPr.Visible = False
        End If
    ...
    Private Sub frmPreviews_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
